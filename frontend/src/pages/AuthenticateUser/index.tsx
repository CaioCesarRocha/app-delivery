...
export function AuthenticateUser() {
  ...
  const [typeUserLogin, setTypeUserLogin] = useState<'client' | 'deliveryman'>(
    'client',
  )
  ...
  async function handleLogin(data: NewDeliveryFormInputs) {
    if (screen === 'Login') {
      ...
      if (data.typeUser === undefined) {
        toast.info('Selecione o tipo de usuário')
        return
      }
      ...
      <>
        ...
        {typeUserLogin === 'client' ? (
          <p>
            ...
            <a href="#/" onClick={() => setTypeUserLogin('deliveryman')}>
              Login aqui.
            </a>
          </p>
        ) : (
          <p>
            ...
            <a href="#/" onClick={() => setTypeUserLogin('client')}>
              Login aqui.
            </a>
          </p>
        )}
    ...
    <DeliveryContainer>
      ...
      <DeliveryContent>
        ...
        <form onSubmit={handleSubmit(handleLogin)}>
          ...
          {screen === 'Login' ? renderLoginInfos() : renderRegisterFields()}
